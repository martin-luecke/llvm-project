...
emitGetNamedOperandIdx(raw_ostream &OS,
                       ...
                       bool ExportNamedOperandTable) {
  if (ExportNamedOperandTable)
    OS << "LLVM_ABI ";
...
void InstrInfoEmitter::emitOperandNameMappings(
  ...
  const bool ExportNamedOperandTable =
      Target.getInstructionSet()->getValueAsBit("ExportNamedOperandTable");
