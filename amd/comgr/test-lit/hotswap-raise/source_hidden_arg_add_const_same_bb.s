...
; transfer function in handle-sop2.cpp.
	...
	.text
	.globl	source_hidden_add_const_same_bb
	.p2align	8
	.type	source_hidden_add_const_same_bb,@function
; CHECK-LABEL: define amdgpu_kernel void @source_hidden_add_const_same_bb(
source_hidden_add_const_same_bb:
...
; CHECK: load i64, ptr addrspace(4) %{{[^,]+}}, align 8
	...
	.p2align	6, 0x0
	.amdhsa_kernel source_hidden_add_const_same_bb
...
amdhsa.kernels:
  - .args:
    ...
    .name:           source_hidden_add_const_same_bb
    .private_segment_fixed_size: 0
    .sgpr_count:     4
    .sgpr_spill_count: 0
    .symbol:         source_hidden_add_const_same_bb.kd
