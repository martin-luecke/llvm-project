...
; CLAMP: %v_add_max_u32_sum{{[0-9]*}} = call i32 @llvm.uadd.sat.i32(i32 {{[^,]+}}, i32 {{[^,]+}})
...
;
	...
	.text
	.globl	v_add_max_u32_kernel
	.p2align	8
	.type	v_add_max_u32_kernel,@function
v_add_max_u32_kernel:
	...
	s_wait_loadcnt 0x0
	v_add_max_u32 v0, s2, -1, v0
	global_store_b32 v3, v0, s[0:1] scale_offset
	s_endpgm
	.globl	v_add_max_u32_clamp_kernel
	.p2align	8
	.type	v_add_max_u32_clamp_kernel,@function
v_add_max_u32_clamp_kernel:
	v_mov_b32_e32 v0, 1
	v_mov_b32_e32 v1, 2
	v_mov_b32_e32 v2, 3
	v_add_max_u32 v0, v0, v1, v2 clamp
	s_endpgm
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel v_add_max_u32_kernel
	...
	.end_amdhsa_kernel
	.p2align	6, 0x0
	.amdhsa_kernel v_add_max_u32_clamp_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           v_add_max_u32_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     6
    .symbol:         v_add_max_u32_kernel.kd
    .vgpr_count:     4
    .wavefront_size: 32
  - .args: []
    .group_segment_fixed_size: 0
    ...
    .max_flat_workgroup_size: 1024
    .name:           v_add_max_u32_clamp_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     8
    .symbol:         v_add_max_u32_clamp_kernel.kd
    .vgpr_count:     3
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
