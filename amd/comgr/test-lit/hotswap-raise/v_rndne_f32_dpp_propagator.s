...
; CHECK: declare i32 @llvm.amdgcn.ds.bpermute(i32, i32)
	...
	.text
	.globl	v_rndne_f32_dpp_propagator_kernel
	.p2align	8
	.type	v_rndne_f32_dpp_propagator_kernel,@function
v_rndne_f32_dpp_propagator_kernel:       ; @v_rndne_f32_dpp_propagator_kernel
; %bb.0:
	s_clause 0x1
	...
	.p2align	6, 0x0
	.amdhsa_kernel v_rndne_f32_dpp_propagator_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           v_rndne_f32_dpp_propagator_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     6
    .symbol:         v_rndne_f32_dpp_propagator_kernel.kd
    .vgpr_count:     2
    .wavefront_size: 32
