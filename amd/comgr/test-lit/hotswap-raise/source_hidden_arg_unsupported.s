...
; Unsupported source hidden-argument kind refused during kernarg-provenance remap.
	...
	.text
	.globl	unsupported_hidden_printf
	.p2align	8
	.type	unsupported_hidden_printf,@function
unsupported_hidden_printf:
; CHECK: unsupported source hidden argument kind 'hidden_printf_buffer'
	...
	.p2align	6, 0x0
	.amdhsa_kernel unsupported_hidden_printf
...
amdhsa.kernels:
  - .args:
    ...
    .name:           unsupported_hidden_printf
    .private_segment_fixed_size: 0
    .sgpr_count:     4
    .sgpr_spill_count: 0
    .symbol:         unsupported_hidden_printf.kd
