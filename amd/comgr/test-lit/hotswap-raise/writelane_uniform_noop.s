...
; writelane uniform no-op elision.
...
; REWRITE-NOT: call i32 @llvm.amdgcn.writelane
	...
	.text
	.globl	writelane_uniform_noop_kernel
	.p2align	8
	.type	writelane_uniform_noop_kernel,@function
writelane_uniform_noop_kernel:          ; @writelane_uniform_noop_kernel
; %bb.0:
	s_clause 0x1
	...
	.p2align	6, 0x0
	.amdhsa_kernel writelane_uniform_noop_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           writelane_uniform_noop_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     6
    .symbol:         writelane_uniform_noop_kernel.kd
    .vgpr_count:     2
    .wavefront_size: 32
