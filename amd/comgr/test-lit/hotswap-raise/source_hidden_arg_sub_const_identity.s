...
; Constant subtraction from the entry kernarg pointer stays an Entry+Const fact, remapped to target implicitarg.ptr offset 80.
	...
	.text
	.globl	source_hidden_sub_const_identity
	.p2align	8
	.type	source_hidden_sub_const_identity,@function
; CHECK-LABEL: define amdgpu_kernel void @source_hidden_sub_const_identity(
source_hidden_sub_const_identity:
...
; CHECK: load i64, ptr addrspace(4) %{{[^,]+}}, align 8
	...
	.p2align	6, 0x0
	.amdhsa_kernel source_hidden_sub_const_identity
...
amdhsa.kernels:
  - .args:
    ...
    .name:           source_hidden_sub_const_identity
    .private_segment_fixed_size: 0
    .sgpr_count:     4
    .sgpr_spill_count: 0
    .symbol:         source_hidden_sub_const_identity.kd
