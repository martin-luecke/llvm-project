...
; CHECK: declare {{.*}}i64 @llvm.ctpop.i64(i64)
	...
	.text
	.globl	s_bcnt1_i32_b64_kernel
	.p2align	8
	.type	s_bcnt1_i32_b64_kernel,@function
s_bcnt1_i32_b64_kernel:
	s_bcnt1_i32_b64 s2, s[0:1]
	s_endpgm
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel s_bcnt1_i32_b64_kernel
...
amdhsa.kernels:
  - .args: []
    ...
    .name:           s_bcnt1_i32_b64_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     8
    .symbol:         s_bcnt1_i32_b64_kernel.kd
    .vgpr_count:     0
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
