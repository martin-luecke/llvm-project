...
; global_atomic_{add,max_num,min_num}_f64: f64 atomicrmw fadd/fmaximumnum/fminimumnum.
	.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"
	.amdhsa_code_object_version 6
	.text
	.globl	global_atomic_f64_kernel
	.p2align	8
	.type	global_atomic_f64_kernel,@function
; CHECK-LABEL: define amdgpu_kernel void @global_atomic_f64_kernel(
global_atomic_f64_kernel:
...
; CHECK-NOT: atomicrmw fminimum ptr
	...
	.p2align	6, 0x0
	.amdhsa_kernel global_atomic_f64_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           global_atomic_f64_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     4
    .symbol:         global_atomic_f64_kernel.kd
    .vgpr_count:     4
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
