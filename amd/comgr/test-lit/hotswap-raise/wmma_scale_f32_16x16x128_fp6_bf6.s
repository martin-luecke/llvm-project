...
; Scaled f8f6f4 WMMA fp6xbf6 format re-encode, gfx942.
	.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"
	.amdhsa_code_object_version 6
	.text
	.globl	wmma_scale_f32_16x16x128_fp6_bf6_kernel
	.p2align	8
	.type	wmma_scale_f32_16x16x128_fp6_bf6_kernel,@function
wmma_scale_f32_16x16x128_fp6_bf6_kernel:
...
; IR_GFX942-NOT: @llvm.amdgcn.mfma.scale.f32.16x16x128.f8f6f4
	v_wmma_scale_f32_16x16x128_f8f6f4 v[24:31], v[0:11], v[12:23], v[24:31], s42, s43 matrix_a_fmt:MATRIX_FMT_FP6 matrix_b_fmt:MATRIX_FMT_BF6
	s_clause 0x1
	...
	.p2align	6, 0x0
	.amdhsa_kernel wmma_scale_f32_16x16x128_fp6_bf6_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           wmma_scale_f32_16x16x128_fp6_bf6_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     52
    .symbol:         wmma_scale_f32_16x16x128_fp6_bf6_kernel.kd
    .vgpr_count:     41
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
