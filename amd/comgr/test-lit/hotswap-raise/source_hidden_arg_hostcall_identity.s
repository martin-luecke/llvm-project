...
; hidden_hostcall_buffer resolved through Entry+Const kernarg provenance carried across a predecessor block, remapped to target implicitarg.ptr offset 80.
	...
	.text
	.globl	source_hidden_hostcall_identity
	.p2align	8
	.type	source_hidden_hostcall_identity,@function
; CHECK-LABEL: define amdgpu_kernel void @source_hidden_hostcall_identity(
source_hidden_hostcall_identity:
	s_add_nc_u64 s[0:1], s[0:1], 0x10
	s_branch .Lload
	s_nop 0
.Lload:
...
; CHECK: load i64, ptr addrspace(4) %{{[^,]+}}, align 8
	...
	.p2align	6, 0x0
	.amdhsa_kernel source_hidden_hostcall_identity
...
amdhsa.kernels:
  - .args:
    ...
    .name:           source_hidden_hostcall_identity
    .private_segment_fixed_size: 0
    .sgpr_count:     4
    .sgpr_spill_count: 0
    .symbol:         source_hidden_hostcall_identity.kd
