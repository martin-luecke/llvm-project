...
; RUN:   --emit-ir=kernarg_memory_load_nonentry_strict_mode 2>/dev/null \
...
;
; Contrast with kernarg_rebased_sload_b128_strict_mode.s, where an `s_add`
; after the load leaves the pair Clobbered and strict mode refuses.
