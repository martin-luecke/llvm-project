...
; CHECK-NOT: call {{.*}}@llvm.fshl
	...
	.text
	.globl	v_alignbit_b32_kernel
	.p2align	8
	.type	v_alignbit_b32_kernel,@function
v_alignbit_b32_kernel:
	...
	.p2align	6, 0x0
	.amdhsa_kernel v_alignbit_b32_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           v_alignbit_b32_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     6
    .symbol:         v_alignbit_b32_kernel.kd
    .vgpr_count:     4
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
