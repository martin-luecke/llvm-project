...
; Lower DPP row_xmask to ds_bpermute selector.
...
; CHECK-DAG: %cwd_dpp_xmask_src = xor i32 %cwd_dpp_within_row, 2
...
; CHECK: declare i32 @llvm.amdgcn.ds.bpermute(i32, i32)
	...
	.text
	.globl	c2_dpp_row_xmask_kernel
	.p2align	8
	.type	c2_dpp_row_xmask_kernel,@function
c2_dpp_row_xmask_kernel:                ; @c2_dpp_row_xmask_kernel
; %bb.0:
	s_clause 0x1
	...
	.p2align	6, 0x0
	.amdhsa_kernel c2_dpp_row_xmask_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           c2_dpp_row_xmask_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     6
    .symbol:         c2_dpp_row_xmask_kernel.kd
    .vgpr_count:     2
    .wavefront_size: 32
