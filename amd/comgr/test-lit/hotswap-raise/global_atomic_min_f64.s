...
; CHECK-NOT: atomicrmw fmin float
	...
	.text
	.globl	global_atomic_min_f64_kernel
	.p2align	8
	.type	global_atomic_min_f64_kernel,@function
global_atomic_min_f64_kernel:
	...
	.p2align	6, 0x0
	.amdhsa_kernel global_atomic_min_f64_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           global_atomic_min_f64_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     4
    .symbol:         global_atomic_min_f64_kernel.kd
    .vgpr_count:     4
    .wavefront_size: 64
amdhsa.version: [1, 2]
...
