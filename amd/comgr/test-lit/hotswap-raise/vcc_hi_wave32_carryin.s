...
; RUN:     --emit-ir=vcc_hi_carryin_kernel | %FileCheck %s

; vcc_hi as a regular SGPR feeds carry-in to v_add_co_ci_u32 via wave32->wave64 mask translation.
...
; CHECK-NOT: zext i1 %vcmp
        ...
        .p2align        6, 0x0
        .amdhsa_kernel vcc_hi_carryin_kernel
...
amdhsa.kernels:
  - .args: []
    ...
    .name:           vcc_hi_carryin_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     8
    .symbol:         vcc_hi_carryin_kernel.kd
    .vgpr_count:     8
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
