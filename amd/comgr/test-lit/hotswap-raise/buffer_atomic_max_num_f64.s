...
; RUN:     --emit-ir=buffer_atomic_max_num_f64_kernel 2>/dev/null \
; RUN:   | %FileCheck %s
;
; CAS-loop lift test for buffer_atomic_max_num_f64 from a gfx1250
; source binary. Mirror of buffer_atomic_min_num_f64.s; pins the
; IEEE 754-2019 maximumNumber path (uses `llvm.maximumnum.f64`
; rather than the gfx942 raw `fcmp ogt` + `select`).

; CHECK-LABEL: define amdgpu_kernel void @buffer_atomic_max_num_f64_kernel(
...
; CHECK-NOT: atomicrmw fmax
	...
	.text
	.globl	buffer_atomic_max_num_f64_kernel
	.p2align	8
	.type	buffer_atomic_max_num_f64_kernel,@function
buffer_atomic_max_num_f64_kernel:
	...
	.p2align	6, 0x0
	.amdhsa_kernel buffer_atomic_max_num_f64_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           buffer_atomic_max_num_f64_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     4
    .symbol:         buffer_atomic_max_num_f64_kernel.kd
    .vgpr_count:     4
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
