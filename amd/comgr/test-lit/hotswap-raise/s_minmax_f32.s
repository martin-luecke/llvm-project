...
; CHECK-NOT: call {{.*}}@llvm.minnum.f32
; CHECK-NOT: call {{.*}}@llvm.maximumnum.f32
; CHECK-NOT: call {{.*}}@llvm.minimumnum.f32

	.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"
	.amdhsa_code_object_version 6
	.text
	.globl	s_minmax_f32_kernel
	.p2align	8
	.type	s_minmax_f32_kernel,@function
s_minmax_f32_kernel:
	...
	;;#ASMSTART
	s_maximum_f32 s0, s6, s7
	s_minimum_f32 s1, s6, s7
	;;#ASMEND
	v_mov_b32_e32 v1, s0
	v_mov_b32_e32 v2, s1
	...
	.p2align	6, 0x0
	.amdhsa_kernel s_minmax_f32_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           s_minmax_f32_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     8
    .symbol:         s_minmax_f32_kernel.kd
    .vgpr_count:     3
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
