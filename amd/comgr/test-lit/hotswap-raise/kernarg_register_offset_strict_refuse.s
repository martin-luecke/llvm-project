...
; CHECK: dynamic source kernarg offsets may reach the source implicit-arg range
	...
	.text
	.globl	kernarg_register_offset_strict_refuse
	.p2align	8
	.type	kernarg_register_offset_strict_refuse,@function
kernarg_register_offset_strict_refuse:
	s_mov_b32 s4, 0xc
	...
	.p2align	6, 0x0
	.amdhsa_kernel kernarg_register_offset_strict_refuse
...
amdhsa.kernels:
  - .args:
    ...
    .name:           kernarg_register_offset_strict_refuse
    .private_segment_fixed_size: 0
    .sgpr_count:     5
    .symbol:         kernarg_register_offset_strict_refuse.kd
    .vgpr_count:     1
    .wavefront_size: 32
