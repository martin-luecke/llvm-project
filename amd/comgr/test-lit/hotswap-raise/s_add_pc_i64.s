...
; RUN: raise_cli %t.hsaco --target-isa=gfx942 --emit-ir=add_pc_i64_lit64_kernel 2>/dev/null | %FileCheck %s --check-prefix=LIT64
;
...
add_pc_i64_lit64_kernel:
	s_load_b64 s[0:1], s[0:1], 0x0
	;;#ASMSTART
	; Force FE/lit64 encoding directly:
	;   [0xfe,0x4b,0x80,0xbe] + literal64(8) => 12-byte instruction
	.long	0xbe804bfe
	.long	0x00000008
	.long	0x00000000
	s_nop 0
