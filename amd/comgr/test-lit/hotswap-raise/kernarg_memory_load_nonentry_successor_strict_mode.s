...
; NonEntry kernarg provenance proven across a successor block: load lifts to ordinary global memory under strict mode.
	...
	.text
	.globl	kernarg_memory_load_nonentry_successor_strict_mode
	.p2align	8
	.type	kernarg_memory_load_nonentry_successor_strict_mode,@function
; STRICT-LABEL: define amdgpu_kernel void @kernarg_memory_load_nonentry_successor_strict_mode(
kernarg_memory_load_nonentry_successor_strict_mode:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           kernarg_memory_load_nonentry_successor_strict_mode
    .private_segment_fixed_size: 0
    .sgpr_count:     8
    .symbol:         kernarg_memory_load_nonentry_successor_strict_mode.kd
    .vgpr_count:     1
    .wavefront_size: 32
