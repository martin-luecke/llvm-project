//===- mxfp4_dequant_test.cpp - mxfp4_dequant unit tests ------------------===//
//
...
// of the IR emitter in `handle-valu.cpp::emitCvtScalePk8Bf16Fp4CrossTargetExpansion`;
...
#include "hotswap/mxfp4-dequant.h"
...
TEST(Mxfp4Dequant, OcpTableBitPatterns) {
  // The LUT exported from mxfp4-dequant.cpp must byte-for-byte match
...
TEST(Mxfp4Dequant, BitAlgebraMatchesLutOnEntireDomain) {
  ...
  // test fails, `handle-valu.cpp::emitCvtScalePk8Bf16Fp4CrossTargetExpansion`
