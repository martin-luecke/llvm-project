...
llvm::Error linkOCMLRuntimeImpl(llvm::Module &M,
                                llvm::StringRef TargetProcessor,
                                unsigned TargetWaveSize) {
  DeviceLibLinkState State;
...
llvm::Error linkOCMLRuntime(llvm::Module &M, llvm::StringRef KernelName,
                            llvm::StringRef TargetProcessor,
                            unsigned TargetWaveSize) {
  if (llvm::Error Err = linkOCMLRuntimeImpl(M, TargetProcessor, TargetWaveSize))
