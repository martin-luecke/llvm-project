...
void writeSelectedU16Half(RaiseContext &Ctx, ParsedReg Dst, Value *Result,
  ...
  Value *Shifted = Ctx.B.CreateShl(ResultZ, 16, "", /*HasNUW=*/true);
...
HandlerResult handleVALU(RaiseContext &Ctx, const DecodedInst &Di,
  ...
  if (Sop == CanonicalOp::V_CVT_PK_F16_F32) {
    ...
    Ctx.writeReg32(Op.dst(),
        Ctx.B.CreateDisjointOr(B0, Ctx.B.CreateShl(B1, 16, "", /*HasNUW=*/true),
                               "pk_f16"));
    Hr.Handled = true;
    return Hr;
  }
  ...
  if (Sop == CanonicalOp::V_CVT_PK_BF16_F32) {
    ...
    Ctx.writeReg32(Op.dst(), Ctx.B.CreateDisjointOr(Bits0, Ctx.B.CreateShl(Bits1, 16, "", /*HasNUW=*/true), "pk_bf16"));
    Hr.Handled = true;
    return Hr;
  }
