...
#define S(N) case CanonicalOp::N: return #N;
  switch (Op) {
    ...
    S(V_CEIL_F64) S(V_TRUNC_F64) S(V_FLOOR_F64)
    S(V_RSQ_F64) S(V_RNDNE_F64) S(V_FRACT_F64)
    S(V_FREXP_MANT_F32) S(V_FREXP_EXP_I32_F32)
    S(V_FREXP_MANT_F64)
    ...
    S(V_PK_ADD_U16) S(V_PK_LSHLREV_B16) S(V_PK_LSHRREV_B16)
    S(V_PK_MUL_LO_U16)
