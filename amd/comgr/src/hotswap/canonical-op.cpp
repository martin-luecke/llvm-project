...
#define S(N) case CanonicalOp::N: return #N;
  switch (Op) {
    ...
    S(S_WAITCNT) S(S_WAIT_LOADCNT) S(S_WAIT_STORECNT)
    S(S_WAIT_KMCNT) S(S_WAIT_DSCNT) S(S_WAIT_XCNT)
    ...
    S(S_MAXIMUM_F16) S(S_MAXIMUM_F32)
    ...
    S(V_ADD_MIN_I32)
    S(V_ADD_MAX_I32)
    S(V_BCNT_U32_B32) S(V_BFE_U32) S(V_BFE_I32) S(V_BFI_B32) S(V_PERM_B32)
    ...
    S(V_MAX3_U32) S(V_MAX3_I16) S(V_MIN3_U32) S(V_MED3_I32)
    ...
    S(V_RCP_F64) S(V_RSQ_F64) S(V_LDEXP_F64)
