...
#define S(N) case CanonicalOp::N: return #N;
  switch (Op) {
    ...
    S(S_WAITCNT) S(S_WAIT_LOADCNT) S(S_WAIT_STORECNT) S(S_WAIT_KMCNT) S(S_WAIT_DSCNT) S(S_WAIT_XCNT)
    ...
    S(S_BUFFER_LOAD_B32) S(S_BUFFER_LOAD_B64) S(S_BUFFER_LOAD_B96)
    S(S_BUFFER_LOAD_B128) S(S_BUFFER_LOAD_B256) S(S_BUFFER_LOAD_B512)
    ...
    S(S_BCNT1_I32_B32) S(S_BCNT1_I32_B64)
    ...
    S(S_CVT_F16_F32) S(S_CVT_F32_F16) S(S_CVT_HI_F32_F16)
    S(S_CVT_F32_U32) S(S_CVT_F32_I32) S(S_CVT_U32_F32) S(S_CVT_I32_F32)
    S(S_CEIL_F32) S(S_FLOOR_F32) S(S_TRUNC_F32) S(S_RNDNE_F32)
    ...
    S(S_FMAC_F32)
    S(S_FMAAK_F32) S(S_FMAMK_F32)
    S(S_MAX_NUM_F32) S(S_MIN_NUM_F32)
    S(S_MAXIMUM_F16) S(S_MINIMUM_F16) S(S_MAXIMUM_F32) S(S_MINIMUM_F32)
    S(S_BFE_U32) S(S_BFE_I32) S(S_BFE_I64) S(S_BFM_B32) S(S_BFM_B64)
    ...
    S(V_CVT_F32_F64) S(V_CVT_F64_F32)
    S(V_CVT_F64_U32) S(V_CVT_F64_I32) S(V_CVT_U32_F64) S(V_CVT_I32_F64)
    S(V_RCP_IFLAG_F32) S(V_RCP_F32) S(V_RSQ_F32) S(V_SQRT_F32)
    S(V_RSQ_F64) S(V_SQRT_F64)
    S(V_EXP_F32) S(V_LOG_F32) S(V_TANH_F32) S(V_SIN_F32) S(V_COS_F32)
    S(V_FREXP_EXP_I32_F64)
    S(V_COS_BF16) S(V_EXP_BF16) S(V_LOG_BF16) S(V_RCP_BF16)
    S(V_RSQ_BF16) S(V_SIN_BF16) S(V_SQRT_BF16) S(V_TANH_BF16)
    ...
    S(V_FREXP_MANT_F32) S(V_FREXP_EXP_I32_F32) S(V_FREXP_MANT_F64)
    ...
    S(V_MAD_I32_I24) S(V_MAD_U32_U24) S(V_MAD_U32) S(V_MAD_U16)
    ...
    S(V_MED3_NUM_F32) S(V_MAX3_NUM_F32) S(V_MIN3_NUM_F32)
    S(V_MAX3_U32) S(V_MIN3_U32) S(V_MAX3_I32) S(V_MIN3_I32) S(V_MED3_I32)
    S(V_MINMAX_NUM_F32) S(V_MAXMIN_NUM_F32)
    S(V_MAX_NUM_F32) S(V_MIN_NUM_F32)
    S(V_MAXIMUM_F32) S(V_MINIMUM_F32)
    S(V_MAXIMUM3_F32) S(V_MINIMUM3_F32)
    S(V_MAXIMUMMINIMUM_F32) S(V_MINIMUMMAXIMUM_F32)
    S(V_DIV_FIXUP_F32) S(V_DIV_FMAS_F32) S(V_DIV_SCALE_F32)
    S(V_DIV_FIXUP_F64) S(V_DIV_FMAS_F64) S(V_DIV_SCALE_F64)
    S(V_FMA_MIX_F32) S(V_FMA_MIX_F32_BF16)
    S(V_FMA_MIXLO_F16) S(V_FMA_MIXHI_F16)
    S(V_FMA_MIXLO_BF16) S(V_FMA_MIXHI_BF16)
    S(V_ADD_F16) S(V_MUL_F16) S(V_SUB_F16) S(V_SUBREV_F16)
    S(V_MAC_F16) S(V_FMAC_F16) S(V_MADMK_F16) S(V_MADAK_F16)
    S(V_FMA_F16)
    S(V_MAX_NUM_F16) S(V_MIN_NUM_F16)
    S(V_MINMAX_NUM_F16) S(V_MAXMIN_NUM_F16)
    S(V_MAXIMUM_F16) S(V_MINIMUM_F16)
    S(V_MAXIMUM3_F16) S(V_MINIMUM3_F16)
    S(V_MAXIMUMMINIMUM_F16) S(V_MINIMUMMAXIMUM_F16)
    S(V_LDEXP_F16) S(V_FLOOR_F16) S(V_TANH_F16)
    S(V_RCP_F16) S(V_RSQ_F16) S(V_SQRT_F16) S(V_EXP_F16) S(V_LOG_F16)
    S(V_SIN_F16) S(V_COS_F16) S(V_RNDNE_F16) S(V_TRUNC_F16) S(V_CEIL_F16)
    S(V_FRACT_F16) S(V_BCNT_U32_B32)
    ...
    S(V_FMAMK_F64) S(V_FMAAK_F64)
    S(V_MAX_NUM_F64) S(V_MIN_NUM_F64)
    S(V_MAXIMUM_F64) S(V_MINIMUM_F64)
    S(V_RCP_F64) S(V_LDEXP_F64) S(V_TRIG_PREOP_F64)
    S(V_MAX_U32) S(V_MIN_U32) S(V_MAX_I32) S(V_MIN_I32)
    S(V_MAXMIN_U32) S(V_MINMAX_U32) S(V_MAXMIN_I32) S(V_MINMAX_I32)
    ...
    S(V_PK_FMA_F16) S(V_PK_ADD_F16) S(V_PK_MUL_F16)
    S(V_PK_ADD_BF16) S(V_PK_MUL_BF16)
    S(V_PK_MIN_NUM_BF16) S(V_PK_MAX_NUM_BF16) S(V_PK_FMA_BF16)
    S(V_PK_ADD_U16) S(V_PK_LSHLREV_B16) S(V_PK_ASHRREV_I16) S(V_PK_LSHRREV_B16)
    S(V_PK_MUL_LO_U16)
    ...
    S(FLAT_STORE_BYTE) S(FLAT_STORE_BYTE_D16_HI)
    S(FLAT_STORE_SHORT) S(FLAT_STORE_SHORT_D16_HI)
    ...
    S(GLOBAL_STORE_BYTE) S(GLOBAL_STORE_BYTE_D16_HI)
    S(GLOBAL_STORE_SHORT) S(GLOBAL_STORE_SHORT_D16_HI)
    S(GLOBAL_STORE_DWORD) S(GLOBAL_STORE_DWORDX2) S(GLOBAL_STORE_DWORDX3) S(GLOBAL_STORE_DWORDX4)
    S(SCRATCH_LOAD_UBYTE) S(SCRATCH_LOAD_SBYTE) S(SCRATCH_LOAD_USHORT) S(SCRATCH_LOAD_SSHORT)
    S(SCRATCH_LOAD_DWORD) S(SCRATCH_LOAD_DWORDX2) S(SCRATCH_LOAD_DWORDX3) S(SCRATCH_LOAD_DWORDX4)
    S(SCRATCH_STORE_BYTE) S(SCRATCH_STORE_SHORT)
    ...
    S(GLOBAL_ATOMIC_ADD_F64) S(GLOBAL_ATOMIC_MIN_NUM_F64) S(GLOBAL_ATOMIC_MAX_NUM_F64)
    // SMEM atomics
    S(S_ATOMIC_SWAP)
    S(S_ATOMIC_DEC)
    // DS
    ...
    S(BUFFER_ATOMIC_ADD_F64)
    S(BUFFER_ATOMIC_MIN_F64) S(BUFFER_ATOMIC_MAX_F64)
    S(BUFFER_ATOMIC_MIN_NUM_F64) S(BUFFER_ATOMIC_MAX_NUM_F64)
    // MFMA
