...
#define S(N) case CanonicalOp::N: return #N;
  switch (Op) {
    ...
    S(V_SWAP_B32)
    S(V_MOVRELD_B32) S(V_MOVRELS_B32) S(V_MOVRELSD_B32)
    ...
    S(V_FREXP_EXP_I32_F32) S(V_FREXP_EXP_I32_F64)
    ...
    S(V_FREXP_MANT_F32) S(V_FREXP_MANT_F64)
    ...
    S(V_CNDMASK_B32) S(V_CNDMASK_B16)
    S(V_AND_B16) S(V_OR_B16) S(V_XOR_B16) S(V_NOT_B16)
    S(V_MUL_LO_U32) S(V_MUL_HI_U32) S(V_MUL_HI_I32)
    S(V_MUL_I32_I24) S(V_MUL_U32_U24) S(V_MUL_HI_U32_U24) S(V_MUL_HI_I32_I24)
    S(V_MAD_I32_I24) S(V_MAD_U32_U24) S(V_MAD_U32)
    ...
    S(V_MED3_I32)
    S(V_MINMAX_I32) S(V_MAXMIN_I32) S(V_MINMAX_U32) S(V_MAXMIN_U32)
    ...
    S(V_PK_MAD_U16) S(V_PK_ADD_U16) S(V_PK_LSHLREV_B16) S(V_PK_LSHRREV_B16)
    S(V_PK_ASHRREV_I16)
    S(V_PK_MUL_LO_U16) S(V_PK_MAX_I16) S(V_PK_MAX3_I16)
    ...
    S(FLAT_ATOMIC_ADD_X2) S(FLAT_ATOMIC_SUB_X2)
    S(FLAT_ATOMIC_AND_X2) S(FLAT_ATOMIC_OR_X2) S(FLAT_ATOMIC_XOR_X2)
    S(FLAT_ATOMIC_SMIN_X2) S(FLAT_ATOMIC_SMAX_X2)
    S(FLAT_ATOMIC_UMIN_X2) S(FLAT_ATOMIC_UMAX_X2)
    S(FLAT_ATOMIC_SWAP_X2) S(FLAT_ATOMIC_CMPSWAP_X2)
