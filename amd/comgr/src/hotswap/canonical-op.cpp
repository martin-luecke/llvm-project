...
#define S(N) case CanonicalOp::N: return #N;
  switch (Op) {
    ...
    S(FLAT_ATOMIC_ADD_F64) S(FLAT_ATOMIC_MIN_F64) S(FLAT_ATOMIC_MAX_F64)
    // GLOBAL atomics
    ...
    S(GLOBAL_ATOMIC_ADD_F64) S(GLOBAL_ATOMIC_MIN_F64) S(GLOBAL_ATOMIC_MAX_F64)
    // SMEM atomics
    S(S_ATOMIC_SWAP)
    S(S_ATOMIC_DEC)
    // DS
    ...
    S(BUFFER_ATOMIC_ADD_F64) S(BUFFER_ATOMIC_MIN_F64) S(BUFFER_ATOMIC_MAX_F64)
    // MFMA
