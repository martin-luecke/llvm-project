//===- tdm-runtime.h - Hotswap transpiler ---------------------------------===//
//
...
#ifndef HOTSWAP_TRANSPILER_TDM_RUNTIME_H
#define HOTSWAP_TRANSPILER_TDM_RUNTIME_H
...
//
// Symbol naming is stable across builds -- `handle-vimage.cpp` declares
...
// per-target dispatch will key on it. On failure returns a
// RaiseFailure::deviceLibraryLinkFailed error attributed to KernelName; the
...
// undefined externals.
llvm::Error linkTDMRuntime(llvm::Module &M, llvm::StringRef KernelName,
                           llvm::StringRef TargetIsa);

} // namespace COMGR::hotswap

#endif // HOTSWAP_TRANSPILER_TDM_RUNTIME_H
