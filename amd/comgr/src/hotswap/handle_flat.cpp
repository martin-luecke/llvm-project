//===- handle_flat.cpp - Hotswap transpiler -------------------------------===//
//
...
HandlerResult handleFLAT(RaiseContext &Ctx, const DecodedInst &Di,
  ...
  // CanonicalOp doc block in `canonical_op.h` for the correctness argument and
  ...
  if (Sop == CanonicalOp::GLOBAL_LOAD_ASYNC_TO_LDS_B8 ||
    ...
    // emulation.  See the CanonicalOp doc block in `canonical_op.h` for the
  ...
  // `canonical_op.h` for the design rationale.
