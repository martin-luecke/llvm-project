//===- mxfp4_dequant.cpp - Hotswap transpiler -----------------------------===//
//
...
// `v_cvt_scale_pk8_bf16_fp4` (gfx1250-only VOP3).  See mxfp4_dequant.h
// for the two functions' contracts and the cross-check invariant the
// unit test asserts.

#include "mxfp4_dequant.h"
...
double e8m0ScaleToDouble(uint8_t ScaleByte) {
