//===- opcode_map.cpp - Hotswap transpiler --------------------------------===//
//
...
static const Entry kCanonTable[] = {
    ...
    // block in `canonical_op.h` for the cross-target correctness
    ...
    // comment in canonical_op.h documents.
    ...
    // CanonicalOp enum comment in canonical_op.h documents.
    ...
    // see the `V_MAD_NC_*` block in `canonical_op.h` for the semantics
