...
static const Entry kCanonTable[] = {
    ...
    // block in `semop.h` for the cross-target correctness
    ...
    // CanonicalOp enum comment in semop.h documents.
    ...
    // see the `V_MAD_NC_*` block in `semop.h` for the semantics
