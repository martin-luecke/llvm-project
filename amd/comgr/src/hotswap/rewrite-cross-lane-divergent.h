//===- rewrite-cross-lane-divergent.h - Hotswap transpiler ----------------===//
//
...
// (internal to `rewrite-cross-lane-divergent.cpp`) and refuse the
...
// see `handle-valu-cross-lane.cpp`'s `V_WRITELANE_B32` /
