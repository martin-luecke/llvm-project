//===- raise_context.h - Hotswap transpiler -------------------------------===//
//
...
struct RaiseContext {
  ...
  // setpc_analysis.h for the full contract; see canonical_op.h's
  ...
  // stay DPP-agnostic. See `decoded_inst.h`'s DPP-state block for how
...
// CanonicalOp stay DPP-agnostic. See `decoded_inst.h`'s DPP-state block
