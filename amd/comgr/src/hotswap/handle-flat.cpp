...
// plain would drop a cross-workgroup handshake (see the commit that added this).
// Only SCOPE_CU / default cpol keeps the plain, optimizable access. An unknown
// scope value is impossible (SCOPE is a 2-bit field), so it is asserted.
