//===- handle_vimage.cpp - Hotswap transpiler -----------------------------===//
//
...
// docstrings in `canonical_op.h` and the canonicalization entries in
...
// `raiseToIR` (see `tdm_runtime.h` and `raiser.cpp`). The helper
