...
static const Entry kCanonTable[] = {
    ...
    // `V_PK_MUL_LO_U16`); the gfx10/gfx11/gfx12/vi realtriples (`_gfx10`,
    // `_vi`, etc.) all canonicalize back to it through the pseudo-alias step.
    // Remaining siblings V_PK_SUB_U16 / V_PK_MIN_{I,U}16 share the same
    // handler shape and remain unenumerated until a corpus producer appears.
    ...
    E(V_ADD_U64_PSEUDO, V_ADD_NC_U64),
    ...
    E(V_SUB_U64_PSEUDO, V_SUB_NC_U64),
