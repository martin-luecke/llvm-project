...
; RUN: %llvm_mc -mcpu=gfx1250 %s -o %t.o && %ld_lld -shared %t.o -o %t.hsaco \
; RUN:   && %not %raise_cli %t.hsaco \
; RUN:     --target-isa=gfx1250 --emit-ir=c2_dpp_fi_refuse_kernel \
; RUN:   2>&1 \
...
; SAME-DAG: Table 57 fetch-inactive semantics

	.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"
	.amdhsa_code_object_version 6
	.text
	.globl	c2_dpp_fi_refuse_kernel
	.p2align	8
	.type	c2_dpp_fi_refuse_kernel,@function
c2_dpp_fi_refuse_kernel:                ; @c2_dpp_fi_refuse_kernel
; %bb.0:
	s_clause 0x1
	...
	.p2align	6, 0x0
	.amdhsa_kernel c2_dpp_fi_refuse_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           c2_dpp_fi_refuse_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     6
    .symbol:         c2_dpp_fi_refuse_kernel.kd
    .vgpr_count:     2
    .wavefront_size: 32
