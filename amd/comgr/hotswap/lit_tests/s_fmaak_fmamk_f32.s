...
; CHECK: [[FMAMK:%[^ ]+]] = call float @llvm.fma.f32(float %{{[^,]+}}, float 2.000000e+00, float %{{[^)]+}})
; CHECK: bitcast float [[FMAMK]] to i32
; CHECK-NOT: unsupported instruction

	.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"
	.amdhsa_code_object_version 6
	.text
	.globl	s_fmaak_fmamk_f32_kernel
	.p2align	8
	.type	s_fmaak_fmamk_f32_kernel,@function
s_fmaak_fmamk_f32_kernel:
	...
	.p2align	6, 0x0
	.amdhsa_kernel s_fmaak_fmamk_f32_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           s_fmaak_fmamk_f32_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     8
    .symbol:         s_fmaak_fmamk_f32_kernel.kd
    .vgpr_count:     2
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
