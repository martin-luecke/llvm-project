...
; CHECK-NOT: call {{.*}}@llvm.amdgcn{{.*}}u16
	...
	.text
	.globl	v_sub_nc_u16_kernel
	.p2align	8
	.type	v_sub_nc_u16_kernel,@function
v_sub_nc_u16_kernel:
	...
	v_sub_nc_u16 v0, v1, v0 op_sel:[1,1,1]
	...
	.p2align	6, 0x0
	.amdhsa_kernel v_sub_nc_u16_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           v_sub_nc_u16_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     6
    .symbol:         v_sub_nc_u16_kernel.kd
    .vgpr_count:     3
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
